    ...
    setStatusData({
      ...
      Buttons: [
        ...
        },
        {
          ...
          BRColor: "#ff0000",
          OnClick: async () =>
            await addNewProduct(newProductName, newProductCategory),
        },
      ],
    });
    setConfimation(true);
  ...
  return (
        ...
        <div>
          {loading ? (
            ...
            <MainForm
              ...
              DataFields={["productName", "categoryName", "productCreatedDate"]}
              Data={[products[page]]}
              Page={Paging}
    ...
    />,
            <SimpleDropDown
              ...
              Flex="1"
              Color="white"
              CallBack={setNewProductCategory}
            />,
          ]}
          Buttons={[
            {
    ...
    />,
            <SimpleInput
              ...
              CallBack={(val) =>
                setUpdateProductData((prev) => ({ ...prev, productName: val }))
              }
              Disabled={false}
            />,
            <SimpleLabel
    ...
    />,
            <SimpleDropDown
              ...
              Color="white"
              CallBack={(val) =>
                setUpdateProductData((prev) => ({ ...prev, categoryID: val }))
              }
              id={updateProductData.categoryID}
            />,
          ]}
          Buttons={[
            {
